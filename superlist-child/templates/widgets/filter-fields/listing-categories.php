<?php /* Mods
2june17 zig - change text of form filter from 'category' to 'type'
 */ ?>
<?php if ( empty( $instance['hide_category'] ) ) : ?>
    <div class="form-group form-group-listing-categories">
        <?php if ( 'labels' == $input_titles ) : ?>
            <label for="<?php echo ! empty( $field_id_prefix ) ? $field_id_prefix : ''; ?><?php echo esc_attr( $args['widget_id'] ); ?>_listing_categories"><?php echo  __( 'Type', 'inventor' );/*  __( 'Category', 'inventor' );*/  ?></label>
        <?php endif; ?>
            ...
            <option value="">
                <?php if ( 'placeholders' == $input_titles ) : ?>
                    <?php /* echo __( 'Category', 'inventor' ); */
                        echo __( 'Any Type', 'inventor' );  ?>
                <?php else : ?>
                    <?php /* echo __( 'All categories', 'inventor' ); */
                    echo __( 'All Types', 'inventor' ); ?>
                <?php endif; ?>
            </option>
